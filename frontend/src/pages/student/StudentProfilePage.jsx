...
/**
 * Student profile — SAFE data only from /api/auth/me (name, email, role,
 * section context). Never displays password/OTP/token data (the backend
 * projection already excludes them). Logout POSTs /api/auth/logout then
 * redirects to /login.
 */
    ...
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      {section ? (
        <Card className="p-6 sm:p-8">
          <h3 className="text-sm font-semibold text-slate-900">My section</h3>
          ...
          <p className="mt-2 text-xs text-slate-400">
            Need a change? Department, session and section assignment are managed by the administration.
          </p>
        </Card>
      ) : (
