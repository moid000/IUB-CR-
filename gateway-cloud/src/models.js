...
/** Gateway session storage — Baileys creds/keys live here so QR survives restarts. */
const waStoreSchema = new Schema(
  {
    _id: { type: String }, // key: 'creds' | 'key-<key>-<idx>'
    v: { type: String, required: true }, // JSON-serialized Baileys object
  },
  { collection: 'wa_store' }
);
export const WaStore = mongoose.model('GwWaStore', waStoreSchema);
